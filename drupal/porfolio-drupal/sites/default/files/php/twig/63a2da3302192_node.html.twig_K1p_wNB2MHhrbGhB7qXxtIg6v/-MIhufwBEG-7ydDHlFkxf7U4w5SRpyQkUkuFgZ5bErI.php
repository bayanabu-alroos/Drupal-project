...
class __TwigTemplate_ac4b7688089ca21eaeabbb7ff53c042d extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
      ...
      ";
            ...
            // line 94
            echo "      ";
            echo t("<span><i class=\"ficon-user user-icon primary\"></i> @author_name</span><span><i class=\"ficon-calendar primary\"></i> @createdDate</span>", array("@author_name" => ($context["author_name"] ?? null), "@createdDate" => ($context["createdDate"] ?? null), ));
            // line 95
            echo "      ";
            if (($context["node_tags"] ?? null)) {
                ...
                if (twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_tags", [], "any", false, false, true, 96)) {
                    // line 97
                    echo "        <span><i class=\"ficon-hashtag primary\"></i>
        ";
                    // line 98
...
";
    ...
    {
        return new Source("", "themes/contrib/ruhi/templates/content/node.html.twig", "C:\\xampp\\htdocs\\porfolio-drupal\\themes\\contrib\\ruhi\\templates\\content\\node.html.twig");
    }
